...
var $mercurymedia$elm_message_toast$MessageToast$Warning = 3;
	...
	function (message, _v0) {
		...
		return A2(
			...
			_Utils_update(
				content,
				{
					v: $mercurymedia$elm_message_toast$MessageToast$Message(message)
				}),
			toast);
	});
...
var $author$project$Main$DragOver = {$: 3};
var $author$project$Main$Drop = F3(
	function (a, b, c) {
		return {$: 4, a: a, b: b, c: c};
	});
var $author$project$Main$Export = {$: 9};
var $author$project$Main$Import = {$: 10};
	...
	function (dismissEvent, config, toast) {
		var defaultToastAttributes = _List_fromArray(
			[
				...
				'message-toast' + (' ' + $mercurymedia$elm_message_toast$MessageToast$toastTypeClass(toast.D))),
...
var $author$project$Main$DragEnd = {$: 2};
